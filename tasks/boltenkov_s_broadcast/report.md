...
|------------------:|---------------------:|---------------------:|---------------------:|---------------------:|
| из библиотеки MPI |  0.06461| 0.11707 | 0.194664 |  0.567068 |
| собственная реализация | 0.0611508 | 0.119611 | 0.228778 | 0.723092 |
...
Собственная реализация работает сравнимо с MPI версией при 1-ом и 2-ух процессах, но при большем числе процессов собственная реализация работает медленнее.
